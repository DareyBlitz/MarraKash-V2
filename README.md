...
2.	Запустить Docker Desktop. Установить соединение в IntelliJ IDEA (Services (Alt + 8), нажать ПКМ на Docker, выбрать `Connect`)
3.	Запустить DBeaver.
...
13.	Открыть отчёт Allure в браузере Google Chrome.
